<form class="form" name="common_form" id="common_form" action="{{ saRoute('testimonial.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="">
        <div class="row form_box">
            ...
            <div class="col-md-12 form-group">
                <label class="form_heading">Designation</label><i class="fa fa-star fill" aria-hidden="true"></i>
                <input class="form-control prompt" type="text" name="designation" id="designation" required value="{{ $value->designation ?? '' }}">
            </div>            
        </div>
